...
def plot_stacked_bar_and_pie(df):
    ...
    occupation_orders.plot(kind='bar', stacked=True, color=plt.cm.tab20.colors, ax=axes[0])
    axes[0].set_title('Total Orders by Occupation ', fontsize=16)
...
def plot_gender_vs_avg_order_value(df):
    """a bar plot showing the average order value by gender with error bars."""
